...
namespace ReactSPA6_ALL.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ReactSPA6_ALLConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ReactSPA6_ALLDbContext context)
        {
            _context = context;
        }
