...
{
    public abstract class ReactSPA6_ALLWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ReactSPA6_ALLWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReactSPA6_ALLWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ReactSPA6_ALLDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ReactSPA6_ALLDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ReactSPA6_ALLDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ReactSPA6_ALLDbContext, Task<T>> func)
        {
            T result;
